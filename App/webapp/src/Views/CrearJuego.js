    ...
    const publicarJuego = async () => {
        if (preguntasTienenRespuestasInpares()) {
            ...
            var dataJuego = {
                ...
                activadoJuego: 1,
                coverJuego: juego.coverJuego != null ? (juego.coverJuego.substring(8) === "https://" ? juego.coverJuego : juego.coverJuego.substring(22)) : "",
            ...
            preguntas.forEach(
                (xd = async function (item, i) {
                    ...
                    await dataJuego.preguntas.push({
                        ...
                        urlAyudaPregunta: item.imgUrl != null ? (item.imgUrl.substring(8) === "https://" ? item.imgUrl : item.imgUrl.substring(22)) : "",
