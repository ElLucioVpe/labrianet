        ...
        return (
            <div className="pregunta card">
                ...
                <div className="grid-2-2 mt-20">
                    <Button classList="item justify-self-end" value={props.respuestas[0] || 'Respuesta 1'}
                            size="regular"
                            onClick={((e) => handleConfigurarRespuesta(e, 0))}/>
                    <Button classList="item justify-self-start"
                            value={props.respuestas[1] || 'Respuesta 2'} size="regular"
                            onClick={((e) => handleConfigurarRespuesta(e, 1))}/>
                    <Button classList="item justify-self-end" value={props.respuestas[2] || 'Respuesta 3'}
                            size="regular"
