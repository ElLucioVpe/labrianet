...
const QuizMasterServices = {
    crearJuego: function (props) {
        return Axios.post(BASE_URL + "/api/Juego/CreateJuego", props, {
            headers: {
                "Content-Type": "application/json",
                Accept: "application/json",
    ...
    updateJuego: function (props) {
        return Axios.post(
            BASE_URL + "/api/Juego/UpdateJuego/" + props.juego.idJuego,
            props.juego,
            {
                headers: {
                    "Content-Type": "application/json",
    ...
    obtenerJugadoresJuego: function (props) {
        return Axios.get(
            BASE_URL + "/api/Juego/GetStatsJugadoresInGame/" + props.id,
            {
                headers: {
                    Authorization: "Token " + process.env.API_TOKEN,
                    Accept: "application/json",
    ...
    obtenerJugadoresUsuario: function (props) {
        return Axios.get(
            BASE_URL + "/api/Juego/GetPlayersQueJugaron?loginname=" + props.loginname,
            {
                headers: {
                    Authorization: "Token " + process.env.API_TOKEN,
                },
    ...
    obtenerArrayJugados: function (props) {
        return Axios.get(
            BASE_URL +
            "/api/Juego/GetArrayPlayersQueJugaron?loginname=" +
            props.loginname,
            {
                headers: {
                    Authorization: "Token " + process.env.API_TOKEN,
    ...
    obtenerJuegosDeUsuario: function (props) {
        return Axios.get(
            BASE_URL + "/api/Juego/GetJuegosJugador?loginName=" + props.usuario,
            {
                headers: {
                    Authorization: "Bearer " + props.accessToken,
                },
    ...
    obtenerRespuestaStats: function (props) {
        return Axios.get(BASE_URL + "/api/Pregunta/GetStatsRespuestas/" + props.id)
            .then((response) => {
                return response.data;
            })
            .catch((error) => {
    ...
    obtenerRanking: function (props) {
        return Axios.get(BASE_URL + "/api/Juego/GetRanking/" + props.id).then(
            (response) => {
                // returning the data here allows the caller to get it through another .then(...)
                return response.data;
            }
    ...
    obtenerProfile: function (props) {
        const {data} = Axios.get(BASE_URL + "/api/Juego/GetJuego/" + props.id, {
            headers: {
                Authorization: "Token " + process.env.API_TOKEN,
                "Content-Type": "application/x-www-form-urlencoded",
            },
    ...
    crearPartida: function (props) {
        return Axios.post(BASE_URL + "/api/Partida/CreatePartida", props, {
            Authorization: "Token " + process.env.API_TOKEN,
            "Content-Type": "application/json",
            Accept: "application/json",
        })
    ...
    respuestaRespondida: function (idRespuesta, idPartida) {
        return Axios.post(
            BASE_URL +
            "/api/Respuesta/RespuestaRespondida?idRespuesta=" +
            idRespuesta +
            "&idPartida=" +
            idPartida
        )
